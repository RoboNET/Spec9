...
export const MANIFEST = [
  ...
  { pattern: 'sources', owner: 'findSpecFiles (loadRepo)', status: 'implemented', reason: 'limits traversal to declared specification directories; files outside the list, such as docs/format.md, are not linted' },
