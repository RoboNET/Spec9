...
// (docs/history/engine-audit-2026-08-30.md M2) — ЗАПРЕЩАЕТСЯ, ЗАПРЕЩЁН, НЕЛЬЗЯ, МОГУТ, МОЖНО, SHALL,
 ...
 * проходят мимо и лукахеда границы, и самого списка слов (docs/history/engine-audit-2026-08-30.md M2).
 * @param {string[]} maskedLines
 * @param {number} startLineNo
