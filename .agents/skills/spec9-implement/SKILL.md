...
spec9 --spec-root <spec-root> --product-root <product-root> trace <requirement-id>
...
spec9 --spec-root <spec-root> --product-root <product-root> review --base <ref> --strict
spec9 --spec-root <spec-root> --product-root <product-root> change --base <ref>
```
